...
describe("Welcome email template function test", () => {
    const htmlTemplate = (0, notification_1.passworTemplate)(firstname, token);
    ...
    test("expect function to throw error when firstname is not specified ", () => {
        expect.assertions(1);
        try {
            (0, notification_1.passworTemplate)("", token);
        }
        catch (err) {
    ...
    test("expect function to throw error when token is not specified ", () => {
        expect.assertions(1);
        try {
            (0, notification_1.passworTemplate)(firstname, "");
        }
        catch (err) {
            const errorMessage = err === null || err === void 0 ? void 0 : err.message;
...
//# sourceMappingURL=ResetPassword.tests.js.map